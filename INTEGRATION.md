...
*Verified against `vendor/FieldStation42` @ `2baa022` (per `~/BoobTube/8008tub3/UPSTREAM.md`) and the 8008TUB3 source at `~/BoobTube/8008tub3/{tuner,adsplice,normalize,mediakit}` on 2026-08-07. Every file:line below was opened, not inferred.*
